...
OUC_PARAMS_FILENAME = CONFIG_PREFIX + 'tracking/white_pingpong.json'
ACTUATOR_PARAMS_FILENAME = CONFIG_PREFIX + 'tracking/blue_actuator2.json'
...
class MembraneHardwareClick(gym.Env):
    metadata = {
    ...
    def __init__(self):
        ...
        cv2.namedWindow('Hardware Membrane')
        cv2.setMouseCallback('Hardware Membrane', capture.click_target)
    ...
    def _step(self, action):
        ...
        TARGET_POS[0] = capture.target_click_pos[0] * PIX2MM - BOX_TRIM_LEFT
        TARGET_POS[1] = (VIEWPORT_H - capture.target_click_pos[1]) * PIX2MM - BOX_TRIM_BOTTOM
